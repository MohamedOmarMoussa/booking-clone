...
export const formSchema = z.object({
  location: z.string().min(2, "Must be 2 characters or more").max(60),
  dates: z.object({
    from: z
      .date()
      .refine((value) => value !== undefined, { message: "Please select a check-in date" }),
    to: z
      .date()
      .refine((value) => value !== undefined, { message: "Please select a check-out date" }),
  }),
  adults: z
    .string()
    .min(1, {
